...
0% {
  ...
  50% {
    box-shadow: 0px 1px 8px 5px #f9eaea4d;
  }
  100% {
...
export default () => {
  return (
    ...
    {new Array(199).fill('').map((x,i) => <Star key={i} size={randomInt(1,4)} />)}
    {new Array(6).fill('').map((x,i)=> <ShootingStar key={i}></ShootingStar>)}
      <header>
        <h1>Ryan Clausen</h1><h2>Fullstack Developer</h2>
